#!/usr/bin/env node
// Minimale MCP stdio-client: start de server, doet initialize, lijst de tools,
// en roept exact_me aan om te bewijzen dat de verbinding met Exact Online werkt.
...
env.EXACT_TOKEN_STORE = process.cwd() + "/.exact-token";
...
const init = await send("initialize", {
  ...
  capabilities: {},
  clientInfo: { name: "boostu-test", version: "1.0.0" },
});
...
const call = await send("tools/call", { name: "exact_me", arguments: {} });
